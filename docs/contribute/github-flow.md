...
<!-- Title: Contributing GithubFlow ResumeTemplate -->
...
To contribute to resume-template project on [GitHub](https://github.com/hadenlabs/resume-template), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/resume-template/pulls).
...
To follow the instructions in this guide and start contributing to resume-template project on GitHub:
